...
public final class Interpreter{
    ...
    void interpret() throws Exception{
		...
		interpret(scanner, false, true, true);
	}

	private void interpret(Scanner in, boolean shouldBeProcessed, boolean shouldTypeCheck, boolean shouldBeEvaluated) throws Exception{
	    tokenize(in);
